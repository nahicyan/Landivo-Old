    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="https://shinyhomes.net/wp-content/uploads/2025/02/Landivo.svg" alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Affordable land deals across Texas, carefully selected for you. Secure your ideal property with confidence and ease. Your dream land is closer than you think.</p>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About Landivo</a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Featured Properties </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Sell Your Land </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Qualify For Financing </a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Disclaimer </a>
                    </li>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe to New Property Alert</p>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Landivo</p>
    </div>
</section>
