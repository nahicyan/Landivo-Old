...
export default function SanAntonioProperty() {
  ...
  const SanAntonioProperties = data.filter((property) => property.area === "SanAntonio");
      ...
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            {SanAntonioProperties.length > 0 ? "Properties in SanAntonio" : "Hot Deals Move Fast!"}
          </h1>
          <p className="text-lg mb-6">
            {SanAntonioProperties.length > 0
              ? "Browse through properties available in the SanAntonio area."
              : (
                <>
        ...
        {SanAntonioProperties.length > 0 ? (
          // Display SanAntonio properties in a horizontal slider
          ...
          // Fallback: Display all properties if no SanAntonio properties are available
