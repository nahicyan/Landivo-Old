...
export default function AustinProperty() {
  ...
  const filteredAustinProperties = austinProperties.filter((property) => {
  ...
  // If there are any filtered Austin properties, display them;
  // otherwise, fallback to showing all properties.
  const displayProperties =
    filteredAustinProperties.length > 0 ? filteredAustinProperties : data;
