...
export default function DFWProperty() {
  ...
  const filteredDFWProperties = DFWProperties.filter((property) => {
  ...
  // If there are any filtered DFW properties, display them;
  // otherwise, fallback to showing all properties.
  const displayProperties =
    filteredDFWProperties.length > 0 ? filteredDFWProperties : data;
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-lg mb-6">
            {filteredDFWProperties.length > 0
              ...
              : (
                <>
                  Sorry! We sold through everything Dallas Fort Worth! <br />
